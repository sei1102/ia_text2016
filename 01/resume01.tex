...
\subsection*{ブレッドボード}
通常の電子工作では、ハンダ付けなどを行いますが、この実習では部品の付け外しが簡単なブレッドボードを使います。このブレッドボードは、ソケット(穴)に部品を差し込むことで電子回路が作ることが出来ます。
１つの部品は必ず２列にまたいで、差すように心掛けましょう。１列上では、電流が流れないので、気をつけましょう。
...
\begin{itemize}
 ...
 \item \textbf{スイッチ}
       ...
       内部でつながっている部分の方向に注意! (図\ref{figure:switch}参照) 
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\columnwidth]{img/LED.eps}
  \caption{LED}
  \label{figure:LED}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\columnwidth]{img/switch.eps}
  \caption{タクトスイッチ}
  \label{figure:switch}
\end{figure}
